...
//                    Ingresar un cadidato 
                ...
                case 3:
                    ...
                    int codigoCand = Integer.parseInt(sc.next());
                ...
                case 4:
                    ...
                    int codigoCand4 = Integer.parseInt(sc.next());
                    ...
                    while (salida2 != true) {
                        ...
                        System.out.println("------------------------------------------------");
                        seleccion2 = Integer.parseInt(sc.next());
                        switch (seleccion2) {
...
//                    Eliminar candidato
                    ...
                    int codigoCand5 = Integer.parseInt(sc.next());
                    ...
                    while (salida3 != true) {
                        ...
                        seleccion3 = Integer.parseInt(sc.next());
                        switch (seleccion3) {
